...
[Authorize]
public class OrdersController(StoreContext context, PaymentsService paymentsService) : BaseApiController
{
    [HttpGet]
    ...
    public async Task<ActionResult<Order>> CreateOrder(CreateOrderDto orderDto)
    {
        ...
        var paymentIntent = await paymentsService.GetPaymentIntent(basket.PaymentIntentId);
