...
export default function InventoryPage() {
  ...
  if(editMode) return <ProductForm  setEditMode={setEditMode} product={selectedProduct} refetch={refetch} setSelectedProduct={setSelectedProduct}></ProductForm>
      ...
      <TableContainer component={Paper}>
            ...
            {data && data.items.map(product => (
              ...
              >
                ...
                <TableCell align="right">
                    ...
                    <Button onClick={() => handleDeleteProduct(product.id)} startIcon={<Delete />} color="error"> </Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
        ...
        <Box sx={{p:3}}>
            {data?.pagination && data.items.length >0 && (
                ...
                onPageChange={(page:number)=> dispatch(setPageNumber(page))}></AppPagination>
            )}
        </Box>
      </TableContainer>
    </>
